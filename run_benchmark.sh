...
# run_benchmark.sh - Reusable benchmark runner for I2EKF-LO (ROS1)
...
echo "=========================================="
echo "Running I2EKF-LO benchmark (ROS1)"
...
IMAGE="${I2EKFLO_IMAGE:-ghcr.io/mapshd/i2ekflo2hdmapping:latest}"
...
docker run --rm -t \
    ...
    bash -lc "
      ...
      roslaunch ${I2EKFLO_LAUNCH} >/tmp/i2ekflo.log 2>&1 &
      LAUNCH_PID=\$!
      ...
      rosrun i2ekf-lo-to-hdmapping listener \"\${REC_BAG}\" \"\${OUT_DIR}/hdmapping\"
    "
